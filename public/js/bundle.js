...
exports.URL = exports.ITUNES_CONFIG = void 0;
var ITUNES_CONFIG = {
  entity: "album",
  limit: 200,
  media: "music"
};
exports.ITUNES_CONFIG = ITUNES_CONFIG;
...
function getAlbums(searchTerm) {
  var params = Object.assign({}, _api.ITUNES_CONFIG, {
    term: searchTerm
  });

  var queryString = _createQueryString(params);

  return axios({
    url: "".concat(_api.URL, "?").concat(queryString),
    adapter: jsonpAdapter
  });
}

},{"./api.config":29,"axios":2,"axios-jsonp":1}],31:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SELECTORS = exports.CLASSES = void 0;
var CLASSES = {
  resultsContentListView: "results__content--listView"
};
exports.CLASSES = CLASSES;
var SELECTORS = {
  album: ".album",
  resultsChangeView: ".results__changeView",
  resultsContent: ".results__content",
  resultsPagination: ".results__pagination",
  resultsWrapper: ".results__wrapper",
...
var _$ = {}; // Global storage for DOM elements
...
function _setElements() {
  _$.searchButton = document.querySelector(_app.SELECTORS.searchButton);
  _$.resultsContent = document.querySelector(_app.SELECTORS.resultsContent);
  _$.resultsChangeView = document.querySelector(_app.SELECTORS.resultsChangeView);
}
/**
...
function _onSearchClick() {
  var $searchField = document.querySelector(_app.SELECTORS.searchField);
  var $resultsPagination = document.querySelector(_app.SELECTORS.resultsPagination);
  var albumsToDisplay;

  if (!searchedValue || searchedValue != $searchField.value) {
    searchedValue = $searchField.value;
    (0, _api.getAlbums)(_getEncodedString(searchedValue)).then(function (result) {
      if (result.data.resultCount > 0) {
        if (result.data.resultCount >= 20) {
          albumsToDisplay = result.data.results.slice(0, 20);
          (0, _paging.createPagination)(result.data.results, $resultsPagination, _$.resultsContent);
        } else {
          albumsToDisplay = result.data.results.slice(0, result.data.resultCount);
        }

        (0, _results.displayAlbums)(albumsToDisplay, _$.resultsContent);
...
function _onChangeView() {
  if (_$.resultsContent.classList.contains(_app.CLASSES.resultsContentListView)) {
    _$.resultsContent.classList.remove(_app.CLASSES.resultsContentListView);
  } else {
    _$.resultsContent.classList.add(_app.CLASSES.resultsContentListView);
  }
}
...
},{"./api/api":30,"./app.config":31,"./paging/paging":34,"./results/results":36}],33:[function(require,module,exports){
"use strict";
...
var _paging = require("./paging.config");
...
function _showAlbumsOfPage(domEvent) {
  var $button = domEvent.target;
  (0, _results.displayAlbums)($button.albums, $button.$resultsContent);
}
/**
 * @param {Array} albums
...
function createPagination(albums, $resultsPagination, $resultsContent) {
  var paginationArray = _createPaginationArray(albums);

  (0, _utils.removeChildren)($resultsPagination);
  paginationArray.forEach(function (page, index) {
    var $button = document.createElement('button');
    $button.dataset.page = index;
    $button.textContent = index + 1;
    $button.classList.add(_paging.CLASSES.paginationButton);
...
},{"../results/results":36,"../utils/utils":37,"./paging.config":33}],35:[function(require,module,exports){
"use strict";
...
exports.displayAlbums = displayAlbums;

var _utils = require("../utils/utils");

var _results = require("./results.config");
...
function _createAlbumTemplate(album) {
  ...
  var htmlString = "<article class='".concat(_results.CLASSES.album, "'>\n  <img class='").concat(_results.CLASSES.img, "' src='").concat(artworkUrl100, "' alt='").concat((collectionName, 120), "' />\n  <div class='").concat(_results.CLASSES.artist, "'>").concat((0, _utils.shortenString)(artistName, 80), "</div>\n  <div class='").concat(_results.CLASSES.albumName, "'>").concat((0, _utils.shortenString)(collectionName, 80), "</div>\n  </article>");
...
function displayAlbums(albums, $resultsContent) {
  (0, _utils.removeChildren)($resultsContent);
  albums.forEach(function (album) {
    $resultsContent.appendChild(_createAlbumTemplate(album));
  });
}

},{"../utils/utils":37,"./results.config":35}],37:[function(require,module,exports){
"use strict";
...
function shortenString(str, limit) {
  if (str.length > limit) {
    return "".concat(str.slice(0, limit), "...");
  }
